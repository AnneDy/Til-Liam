...
time_period = {'month':1, 'bimonth':2, 'quarter':3, 'triannual':4, 'semester':6, 'year':12}
...
# fields handling
# ---------------
str_to_type = {'float': float, 'int': int, 'bool': bool, 'time': np.int32}
...
def fields_yaml_to_type(dict_fields_list):
    ...
    Python types
    '''
    print(fields_str_to_type([d.items()[0] for d in dict_fields_list]))
